...
dial_tcp :: proc(socket : ^Socket, addr : string) -> (err : CommError) {
...
@(private)
recv_message :: proc(socket : ^RecvSocket) -> (msg : Message, err : CommError) {
...
send_message :: proc(socket : ^SendSocket, msg : Message) -> (err : CommError) {
